    ...
    <section class="relative overflow-hidden bg-slate-900 pt-36 pb-24">
        ...
        <div class="relative z-10 max-w-6xl mx-auto px-6 text-center">
            ...
            <p class="mt-7 max-w-3xl mx-auto text-slate-300 leading-relaxed text-lg">
                Solusi engineering dan geoteknik
                untuk pengembangan kawasan industri,
                fasilitas smelter,
                stockyard,
                dan infrastruktur pendukung industri modern.
            </p>
                    ...
                    <div class="project-card bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden group max-w-3xl mx-auto">
                        ...
                        <div class="p-8">
                            ...
                            <h3 class="text-3xl font-black text-slate-900 mb-5 group-hover:text-amber-700 transition">
                                Stockyard Smelter Mapawah
                            </h3>

                            <p class="text-sm text-slate-600 leading-relaxed line-clamp-3">
                                Analisis geoteknik dan engineering
                                untuk pengembangan stockyard fasilitas smelter,
                                termasuk stabilitas lahan,
                                perencanaan pondasi,
                                serta dukungan infrastruktur industri berat.
                            </p>
