...
<head>
    ...
    <title>Pembangkit Energi | GeoINHance</title>
...
<body class="bg-slate-50 font-sans antialiased text-slate-900">
    ...
    <section class="relative bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 text-white py-16 lg:py-24 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center space-y-4">
            ...
            <h1 class="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight leading-none uppercase">
                {{ __('energy.hero_title_1') }} <span class="text-blue-400">{{ __('energy.hero_title_2') }}</span>
            </h1>
    ...
    <section class="max-w-7xl mx-auto pt-16 pb-8 px-4 sm:px-6 lg:px-8">
        ...
        <div id="projectGrid" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {{-- PROJECT 1: PLTU TIMOR-1 --}}
            <div class="project-item transition-all duration-300" data-name="pltu timor-1" data-category="powerplant">
                <article class="bg-white rounded-3xl border border-slate-200 shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden group flex flex-col justify-between min-h-[480px]">
                    <div>
                        ...
                        <div class="relative overflow-hidden h-56 bg-slate-900 flex items-center justify-center">
                            <i class="fa-solid fa-bolt text-[80px] text-blue-500/10 group-hover:scale-110 transition duration-700"></i>
                        ...
                        <div class="p-6 space-y-3">
                            <p class="text-slate-400 text-[11px] font-bold tracking-widest uppercase">
                                <i class="fa-solid fa-location-dot text-blue-500 mr-1"></i> Kupang, Indonesia
                            </p>
            ...
            {{-- Anda bisa menambahkan item data-category="powerplant" lainnya di sini --}}
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // Fungsi utama menyaring data berdasarkan kombinasi Kategori & Teks Pencarian
            function applyFilterAndSearch() {
                ...
                currentPage = 1; // Reset halaman ke awal setiap kali kriteria berubah
                updatePagination();
            }

            // Fungsi memperbarui UI Grid Item dan Pagination Controls
            function updatePagination() {
                ...
                // Tampilkan items yang lolos seleksi halaman aktif saat ini
