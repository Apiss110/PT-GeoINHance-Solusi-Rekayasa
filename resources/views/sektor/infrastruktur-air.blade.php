...
<head>
    ...
    <title>Infrastruktur Air - GeoINHance</title>
...
<body class="bg-slate-50 font-sans antialiased text-slate-900">
    ...
    <section class="relative bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 text-white py-16 lg:py-24 overflow-hidden">
        <div class="absolute inset-0 opacity-10 bg-[radial-gradient(#22d3ee_1px,transparent_1px)] [background-size:16px_16px]"></div>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center space-y-4">
            <span class="bg-cyan-500/20 text-cyan-300 px-3 py-1 rounded-full text-xs font-semibold tracking-wider uppercase border border-cyan-500/30">
                {{ __('water.hero_sector') }}
            </span>
            <h1 class="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight leading-none uppercase">
                {{ __('water.hero_title_1') }} <span class="text-cyan-400">{{ __('water.hero_title_2') }}</span>
            </h1>
    ...
    {{-- NAVIGATION BAR: FILTER BUTTONS & SEARCH BAR --}}
    ...
    <section class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        ...
        <div id="projectGrid" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {{-- PROJECT 1 --}}
            <div class="project-item transition-all duration-300" data-name="stasiun pompa ancol-sentiong">
                <article class="bg-white rounded-3xl border border-slate-200 shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden group flex flex-col justify-between min-h-[480px]">
                    <div>
                        ...
                        <div class="relative overflow-hidden h-56 bg-slate-900 flex items-center justify-center">
                            <i class="fa-solid fa-water text-[80px] text-cyan-500/10 group-hover:scale-110 transition duration-700"></i>
                        ...
                        <div class="p-6 space-y-3">
                            <p class="text-slate-400 text-[11px] font-bold tracking-widest uppercase">
                                <i class="fa-solid fa-location-dot text-cyan-500 mr-1"></i> DKI Jakarta, Indonesia
                            </p>
                            <h3 class="text-lg font-black text-slate-900 leading-tight group-hover:text-cyan-700 transition line-clamp-2 min-h-[3rem]">
                    ...
                    <div class="p-6 pt-0 space-y-4">
                        ...
                        <a href="#" class="inline-flex items-center text-xs font-bold text-cyan-600 hover:translate-x-1 transition-transform uppercase tracking-wider">
            ...
            {{-- PROJECT 2 --}}
            <div class="project-item transition-all duration-300" data-name="spam bekasi">
                <article class="bg-white rounded-3xl border border-slate-200 shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden group flex flex-col justify-between min-h-[480px]">
                    <div>
                        {{-- Thumbnail Area --}}
                        <div class="relative overflow-hidden h-56 bg-slate-900 flex items-center justify-center">
                            <i class="fa-solid fa-faucet-drip text-[80px] text-cyan-500/10 group-hover:scale-110 transition duration-700"></i>
                            <div class="absolute top-4 left-4">
                                <span class="bg-[#002d62] text-white text-[10px] font-bold px-3 py-1 uppercase tracking-widest rounded-full">
                        ...
                        <div class="p-6 space-y-3">
                            <p class="text-slate-400 text-[11px] font-bold tracking-widest uppercase">
                                <i class="fa-solid fa-location-dot text-cyan-500 mr-1"></i> Bekasi, Indonesia
                            </p>
                            <h3 class="text-lg font-black text-slate-900 leading-tight group-hover:text-cyan-700 transition line-clamp-2 min-h-[3rem]">
    ...
    {{-- JAVASCRIPT LOGIC: COMBINED SEARCH & PAGINATION KELIPATAN 6 --}}
    <script>
