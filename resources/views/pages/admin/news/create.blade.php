<x-app-layout>
    <div class="container mx-auto px-6 py-8">
        ...
        <div class="mb-6 flex items-center justify-between">
            <div>
                <h3 class="text-gray-700 text-3xl font-medium">Tambah Berita Baru</h3>
                <p class="text-gray-500 text-sm mt-1">Buat dan publikasikan artikel atau kegiatan event baru.</p>
            </div>
            <div>
                <a href="{{ route('admin.blog.index') }}" class="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 font-medium text-sm inline-flex items-center transition shadow-sm">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden mt-6">
            <form action="{{ route('admin.blog.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {{-- Kategori --}}
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Kategori Berita <span class="text-red-500">*</span></label>
                        <input type="text" name="category" value="{{ old('category') }}" 
                            ...
                            placeholder="Contoh: GEOTEKNIK, BERITA, CORPORATE" required>
                    ...
                    <div class="md:col-span-2">
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Nama / Judul Berita <span class="text-red-500">*</span></label>
                    ...
                    {{-- Foto Berita --}}
                    <div class="md:col-span-2">
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Foto Berita <span class="text-red-500">*</span></label>
                ...
                <div class="flex justify-end pt-4 border-t border-gray-100 space-x-3">
                    <a href="{{ route('admin.blog.index') }}" class="px-5 py-2.5 border border-gray-200 text-gray-700 rounded-lg text-sm font-medium hover:bg-gray-50 transition text-center">
                        Batal
                    </a>
