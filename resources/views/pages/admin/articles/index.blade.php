<x-app-layout>
    <div class="container-fluid px-4 py-4 space-y-6">
        ...
        <div class="w-full bg-[#1e293b] rounded-lg p-6 shadow-lg">
            ...
            {{-- ROUTE DIUBAH KE ARTICLES.STORE --}}
    ...
    {{-- Script Editor Asli Menggunakan JS Bawaan Proyekmu --}}
    <script src="https://cdn.jsdelivr.net/npm/tinymce@6/tinymce.min.js" referrerpolicy="origin"></script>
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            // Inisialisasi TinyMCE bawaan lokal sistemmu (Bebas Warning Kuning)
            tinymce.init({
                selector: '#editor',
                height: 420,
            ...
            // Logika Preview Gambar Unggahan Kontrol Standar HTML
