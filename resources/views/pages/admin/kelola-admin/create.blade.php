<x-app-layout>
    ...
    <!-- Container Lebar Form (col-md-6 disetarakan dengan max-w-2xl) -->
    <div class="max-w-2xl">
        
        <!-- Header Ringkas & Tombol Kembali -->
        <div class="flex justify-between items-center mb-6">
            <h3 class="text-sm font-bold text-gray-500 uppercase tracking-wider">Formulir Otoritas Staff</h3>
        ...
        <div class="bg-white rounded-xl border-l-4 border-[#0e1d82] border-y border-r border-slate-200 shadow-sm">
            <div class="p-6">
                <form action="{{ route('admin.kelola-admin.store') }}" method="POST" class="space-y-5">
                    @csrf
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               value="{{ old('name') }}" 
                               required 
                               placeholder="Masukkan nama lengkap staff baru">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="email" 
                               ...
                               value="{{ old('email') }}" 
                               required 
                               placeholder="contoh@geoinhance.com">
                    </div>

                    <!-- Kolom Password (Tanpa Hash Argon/Sesuai Kebutuhan Kampus) -->
                    <div>
                        ...
                        <input type="password" 
                               ...
                               required 
                               placeholder="••••••••">
                        <p class="text-[11px] text-slate-400 italic">Note: Password akan disimpan langsung demi kemudahan tugas kampus.</p>
                    </div>

                    <!-- Tombol Submit Warna Biru Utama Korporat -->
                    <div class="pt-2">
