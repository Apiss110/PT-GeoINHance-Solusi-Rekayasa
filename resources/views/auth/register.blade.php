...
<body class="bg-slate-50 font-sans antialiased text-slate-900 min-h-screen flex items-center justify-center p-4 sm:p-6 overflow-x-hidden">
    ...
    <!-- Container Utama: h-auto di mobile, md:h-[730px] di desktop -->
    <div class="w-full max-w-5xl h-auto md:h-[730px] bg-white rounded-2xl sm:rounded-3xl overflow-hidden border border-slate-200 shadow-2xl flex flex-col md:flex-row my-auto" data-aos="zoom-in" data-aos-duration="600">
        ...
        <div class="hidden md:flex md:w-1/2 bg-pattern p-10 lg:p-12 flex-col justify-between relative text-white">
            <div class="flex items-center relative z-10">
                <div class="leading-none">
                    <img src="../images/logo_inh.png" alt="GeoINHance Logo" class="h-24 lg:h-28 w-auto object-contain">
                </div>
            </div>
        ...
        <div class="w-full md:w-1/2 p-6 sm:p-8 md:p-12 flex flex-col justify-center relative bg-white">
            ...
            <!-- Header Mobile & Tombol Kembali -->
            <div class="flex items-center justify-between mb-4 md:mb-6">
                <!-- Logo versi HP (Hanya muncul di mobile) -->
                <div class="md:hidden">
                    <img src="../images/inh 2.png" alt="GeoINHance Logo" class="h-12 w-auto object-contain">
                </div>
                
                <a href="/" class="ml-auto text-slate-400 hover:text-slate-900 transition flex items-center text-[11px] sm:text-xs font-bold uppercase tracking-wider group">
            ...
            <div class="mb-4">
                <h3 class="text-2xl sm:text-3xl font-black text-slate-900 uppercase tracking-tight">Buat Akun Baru</h3>
            ...
            <form action="{{ route('register') }}" method="POST" class="space-y-3">
                ...
                <div>
                    <label class="block text-[10px] font-bold uppercase tracking-wider text-slate-500 mb-1">Nama Lengkap / Perusahaan</label>
                    <div class="relative">
                ...
                <div>
                    <label class="block text-[10px] font-bold uppercase tracking-wider text-slate-500 mb-1">Alamat Email Perusahaan</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3" x-data="{ show: false }">
                    <div>
                        <label class="block text-[10px] font-bold uppercase tracking-wider text-slate-500 mb-1">Password Baru</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400">
                    ...
                    <div>
                        <div class="flex justify-between items-center mb-1">
                            <label class="block text-[10px] font-bold uppercase tracking-wider text-slate-500">Konfirmasi</label>
            ...
            <div class="relative my-4">
                ...
                <div class="relative flex justify-center text-xs">
                    <span class="bg-white px-2 text-slate-400 uppercase tracking-widest text-[9px] font-bold">Atau Daftar Lewat</span>
                </div>
            </div>
