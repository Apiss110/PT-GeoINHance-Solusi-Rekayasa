...
<body class="bg-slate-50 font-sans antialiased text-slate-900 min-h-screen flex items-center justify-center p-4 md:p-6">
    ...
    <div class="w-full max-w-5xl h-auto md:h-[730px] bg-white rounded-3xl overflow-hidden border border-slate-200 shadow-2xl flex flex-col md:flex-row" data-aos="zoom-in" data-aos-duration="600">
        ...
        <div class="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center relative bg-white">
            ...
            <form action="{{ route('register') }}" method="POST" class="space-y-3.5">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name') }}" required autofocus autocomplete="name" placeholder="PT Sukses Mandiri / Jhon Doe" 
                            class="w-full bg-slate-50 border border-slate-200 rounded-xl pl-11 pr-4 py-2.5 text-sm focus:outline-none focus:border-red-800 focus:bg-white transition tracking-wide">
                    </div>
                </div>
                ...
                <div class="pt-2">
                    <button type="submit" class="w-full bg-red-800 hover:bg-red-900 text-white font-bold uppercase text-xs tracking-widest py-3 rounded-xl shadow-lg transition duration-300 transform hover:-translate-y-0.5 focus:outline-none">
            ...
            <div class="grid grid-cols-2 gap-2.5">
                <!-- Google -->
                <a href="{{ route('social.redirect', 'google') }}" class="flex items-center justify-center gap-2 py-2.5 px-4 border border-slate-200 rounded-xl hover:border-red-800 hover:bg-slate-50 transition text-[11px] font-bold uppercase tracking-wider text-slate-700 shadow-sm duration-300">
                ...
                <!-- Facebook -->
                <a href="{{ route('social.redirect', 'facebook') }}" class="flex items-center justify-center gap-2 py-2.5 px-4 border border-slate-200 rounded-xl hover:border-blue-600 hover:bg-slate-50 transition text-[11px] font-bold uppercase tracking-wider text-slate-700 shadow-sm duration-300">
