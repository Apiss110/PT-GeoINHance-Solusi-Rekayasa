    ...
    <div class="w-full max-w-5xl h-[720px] bg-white rounded-3xl overflow-hidden border border-slate-200 shadow-2xl flex" data-aos="zoom-in" data-aos-duration="600">
        ...
        <div class="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center relative bg-white">
            ...
            <form action="{{ route('login') }}" method="POST" class="space-y-4">
                ...
                <button type="submit" class="w-full bg-red-800 hover:bg-red-900 text-white font-bold uppercase text-xs tracking-widest py-3.5 rounded-xl shadow-lg transition">
                    Sign In Account
                </button>
            </form>
            ...
            <div class="grid grid-cols-2 gap-3">
                <!-- Google -->
                <a href="{{ route('social.redirect', 'google') }}" class="flex items-center justify-center gap-2 py-3 px-4 border border-slate-200 rounded-xl hover:border-red-800 hover:bg-slate-50 transition text-[11px] font-bold uppercase tracking-wider text-slate-700 shadow-sm duration-300">
                ...
                <!-- Facebook -->
                <a href="{{ route('social.redirect', 'facebook') }}" class="flex items-center justify-center gap-2 py-3 px-4 border border-slate-200 rounded-xl hover:border-blue-600 hover:bg-slate-50 transition text-[11px] font-bold uppercase tracking-wider text-slate-700 shadow-sm duration-300">
